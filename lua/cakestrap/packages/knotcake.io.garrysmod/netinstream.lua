...
-- IStreamReader
function self:UInt8    () return net.ReadUInt ( 8) end
function self:UInt8LE  () return net.ReadUInt ( 8) end
function self:UInt8BE  () return net.ReadUInt ( 8) end

function self:Int8     () return net.ReadInt  ( 8) end
function self:Int8LE   () return net.ReadInt  ( 8) end
function self:Int8BE   () return net.ReadInt  ( 8) end

function self:UInt16LE () return net.ReadUInt (16) end
function self:Int16LE  () return net.ReadInt  (16) end

function self:UInt32LE () return net.ReadUInt (32) end
function self:Int32LE  () return net.ReadInt  (32) end

function self:FloatLE  () return net.ReadFloat  () end
function self:DoubleLE () return net.ReadDouble () end

function self:Char     () return net.ReadData ( 1) end
