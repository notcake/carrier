...
function self:ToString ()
	...
	if self.LeftDataFlowNode:GetOperator () and
	   (self.LeftDataFlowNode:GetOperator () ~= self.Operator or not self.Operator:IsCommutative ()) and
	...
	if self.RightDataFlowNode:GetOperator () and
	   (self.RightDataFlowNode:GetOperator () ~= self.Operator or not self.Operator:IsCommutative ()) and
