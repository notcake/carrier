...
-- Norms
function Cat.LinearAlgebra.Vector3d.L0Norm (self)
	return math.min (math.abs (self [0]), math.abs (self [1]), math.abs (self [2]))
end

function Cat.LinearAlgebra.Vector3d.L1Norm (self)
	return math.abs (self [0]) + math.abs (self [1]) + math.abs (self [2])
end
...
function Cat.LinearAlgebra.Vector3d.LInfinityNorm (self)
	return math.max (math.abs (self [0]), math.abs (self [1]), math.abs (self [2]))
end
...
self.L0Norm          = Cat.LinearAlgebra.Vector3d.L0Norm
