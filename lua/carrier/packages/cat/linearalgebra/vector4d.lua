...
function Cat.LinearAlgebra.Vector4d.L0Norm (self)
	return math.min (math.abs (self [0]), math.abs (self [1]), math.abs (self [2]), math.abs (self [3]))
end

function Cat.LinearAlgebra.Vector4d.L1Norm (self)
	return math.abs (self [0]) + math.abs (self [1]) + math.abs (self [2]) + math.abs (self [3])
end
...
function Cat.LinearAlgebra.Vector4d.LInfinityNorm (self)
	return math.max (math.abs (self [0]), math.abs (self [1]), math.abs (self [2]), math.abs (self [3]))
end
...
self.L0Norm          = Cat.LinearAlgebra.Vector4d.L0Norm
