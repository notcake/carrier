...
-- Norms
function Cat.LinearAlgebra.Vector2d.LNegativeInfinityNorm(self)
	return math_min(math_abs(self[0]), math_abs(self[1]))
end

function Cat.LinearAlgebra.Vector2d.L1Norm(self)
	return math_abs(self[0]) + math_abs(self[1])
end

function Cat.LinearAlgebra.Vector2d.L2Norm(self)
	return math_sqrt(self[0] * self[0] + self[1] * self[1])
end
...
function Cat.LinearAlgebra.Vector2d.LInfinityNorm(self)
	return math_max(math_abs(self[0]), math_abs(self[1]))
end
...
self.LNegativeInfinityNorm = Cat.LinearAlgebra.Vector2d.LNegativeInfinityNorm
